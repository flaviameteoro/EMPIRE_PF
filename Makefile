...
$(OBS)relaxation_profile.o: $(SR_UTILS)relaxation_profile.f90
	$(FC) $(FCOPTS) -c $(SR_UTILS)relaxation_profile.f90 -o $@
...
$(OBS)user_relaxation_profile.o: $(SR_USERS)user_relaxation_profile.f90 $(OBS)sizes.o
	$(FC) $(FCOPTS) -c $(SR_USERS)user_relaxation_profile.f90 -o $@
