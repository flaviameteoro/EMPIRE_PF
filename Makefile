...
Qdata.o: Qdata.f90 sizes.o
	$(FC) $(FCOPTS) -c Qdata.f90

Qevd.o: Qevd.f90 sizes.o
...
model_specific.o: model_specific.f90 sizes.o 
	$(FC) $(FCOPTS) -c model_specific.f90 

operator_wrappers.o: operator_wrappers.f90 pf_control.o sizes.o
	$(FC) $(FCOPTS) -c operator_wrappers.f90 

pf_control.o: pf_control.f90 sizes.o
	$(FC) $(FCOPTS) -c pf_control.f90

perturb_particle.o: perturb_particle.f90 sizes.o
	$(FC) $(FCOPTS) -c perturb_particle.f90

cake:
	cake

data_io.o: data_io.f90 pf_control.o sizes.o
...
sizes.o: sizes.f90
	$(FC) $(FCOPTS) -c sizes.f90 

comms.o: comms.f90 sizes.o pf_control.o
...
diagnostics.o: diagnostics.f90 pf_control.o sizes.o
