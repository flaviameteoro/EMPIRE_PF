...
OBJS= pf_couple.o hadcm3_config.o equal_weight_filter.o comms.o gen_rand.o random_d.o extra.o proposal_filter.o pf_control.o data_io.o model_specific.o operator_wrappers.o
