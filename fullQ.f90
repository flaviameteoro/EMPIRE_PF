...
Contains
  ...
  Subroutine SolveQ (inVector,resultQ)
    ...
    real, INTENT(IN), dimension(:) :: inVector
    real, INTENT(OUT) :: resultQ

    integer :: status, i
    real, dimension(:), allocatable :: xVector, psi, psiSin
  ...
  Subroutine SolveQR (inVector,resVector)
    ...
    real, INTENT(IN), dimension(:) :: inVector
    real, INTENT(OUT), dimension(:) :: resVector
  ...
  Subroutine Aprod(n,x,y)
    ...
    real, dimension(n) :: inVector, resVector
    real, dimension(3*nxn*nyn) :: xVector
    real, dimension(nxn*nyn) :: psi, psiSin
    integer :: i
  ...
  Subroutine CheckQRinverse (inVector, resVector)
    ...
    real, dimension(nObs) :: obsVector
    real, dimension(3*nxn*nyn) :: xVector, QxVector
    integer :: i
  ...
  Subroutine MultiplySqrtQ (inVector, resVector)
    ...
    real, dimension(:), allocatable :: psiSin, psi, xVector
  ...
  Subroutine uTransform(inVector,resVector)
    ...
    real, dimension(nxn,nyn)::psi,u,v,e
    real :: helpdy, helpdx, help
    integer :: i,j
  ...
  Subroutine uBoundary(inVector,resVector)
    ...
    real, dimension(nxn,nyn)::u,v,e,uF,vF,eF
    integer :: i,j
  ...
  Subroutine uTBoundary(inVector,resVector)
    ...
    real, dimension(nxn,nyn)::u,v,e,uhat,vhat,ehat
    integer :: i,j
  ...
  Subroutine uInverse(inVector, resVector)
    ...
    real, dimension(nxn,nyn):: psi,u,v,e,psiTempR,psiTempI
    real, dimension(2*nxn) :: TRIGM
    real, dimension(2*nyn) :: TRIGN
    real, dimension(2*nxn*nyn) :: WORK
    real :: help
    integer :: ifail=0.
    integer :: i,j,n2
  ...
  Subroutine uAdjoint(inVector, resVector)
    ...
    real, dimension(nxn,nyn):: psiHat,u,v,e
    real, dimension(3*nxn*nyn) :: tempVector
  ...
  Subroutine uHatAdjoint(inVector,resVector)
    ...
    real, allocatable, dimension(:) :: psiC, psiR, work
    real, allocatable, dimension(:,:) :: psiSwap, psiFinal
    real, allocatable, dimension(:) :: trigC, trigR
    character*1 :: init
  ...
  Subroutine Measure (psi, lpsi) 
    ...
    real, INTENT(IN),  dimension(:,:)   :: psi
    real, INTENT(OUT), dimension(:)     :: lpsi
